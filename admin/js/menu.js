...
// 		var $arrow=$menu.find('.menu-bar').find('.icon-arrowdown');
...
//         if(($lastMenbar!==null)&&($lastMenbar.get(0)!==$menu.get(0))){
//         	$lastMenbar.find('.menu-items').css('display','none');
//         	var $b=$lastMenbar.find('.menu-bar').find('.icon-arrowup');
//         	console.log($b);
//         	// var $arrow = $('.menu-bar .icon-arrowdown');
//         	$b.removeClass('icon-arrowup');
// 		    $b.addClass('icon-arrowdown');
